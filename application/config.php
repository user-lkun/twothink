...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'K,3-H=[AvRbzc/X%P{Q$s2Fy.jVeNSl)CYi5}JB9', //默认数据加密KEY
	'data_cache_key'=> 'K,3-H=[AvRbzc/X%P{Q$s2Fy.jVeNSl)CYi5}JB9',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'K,3-H=[AvRbzc/X%P{Q$s2Fy.jVeNSl)CYi5}JB9', //加密KEY
