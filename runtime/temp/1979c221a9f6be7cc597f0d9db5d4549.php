<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\twothink\public/../application/admin/view/default/activity\index.html";i:1533800841;s:69:"F:\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <table class="">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo url('Activity/edit?id='.$vo['id']); ?>" class="authorize">修改</a>
                <a href="<?php echo url('Activity/del?id='.$vo['id']); ?>" class="confirm ">删除</a>
            </td>
        </tr>
