<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\twothink\public/../application/admin/view/default/property\index.html";i:1533784182;s:69:"F:\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="cf">
    <div class="fl">
        ...
        <!--<button class="btn ajax-post confirm" url="<?php echo url('Property?method=del'); ?>" target-form="ids">删 除</button>-->
    ...
    <table class="">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo url('Property/edit?id='.$vo['id']); ?>" class="authorize">修改</a>
                <a href="<?php echo url('Property/del?id='.$vo['id']); ?>" class="confirm ">删除</a>
            </td>
        </tr>
