<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"F:\twothink\public/../application/admin/view/default/property\edit.html";i:1533721923;s:69:"F:\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" class="text input-large" name="addr" value="<?php echo $info['addr']; ?>">
        </div>
    </div>

    <div class="form-item">
        <label class="item-label">报修内容</label>
        <div class="controls">
            <textarea name="content" id="" cols="50" rows="5"><?php echo $info['content']; ?></textarea>
        </div>
    </div>
    <div class="form-item">
        <input type="submit"  class="btn btn-return" value="确定修改">
