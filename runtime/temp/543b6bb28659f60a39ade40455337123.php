<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"F:\twothink\public/../application/admin/view/default/property\add.html";i:1533718130;s:69:"F:\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url(); ?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="addr" value="">
            </div>
        </div>
        ...
        <div class="form-item">
            <input type="submit"  class="btn btn-return" value="确 定">
